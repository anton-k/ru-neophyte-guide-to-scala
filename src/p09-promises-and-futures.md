...
В предыдущей главе мы познакомились с типом `Future`, его семантикой, тем как, собирая составные `Future` из простых, мы можем писать очень наглядные асинхронные
программы.
